    ...
    return (
        ...
        >
            ...
            <div className="h-16 border-b border-slate-100 flex items-center px-6 gap-5 shrink-0 z-20 relative rounded-tl-[2.5rem] bg-white">
                ...
                {/* URL Bar */}
                <div className="flex-grow h-10 bg-slate-50 border border-slate-200/60 rounded-xl flex items-center px-4 justify-start gap-3">
                     ...
                     <span className="text-sm text-slate-500 font-medium truncate font-sans tracking-wide">
