            ...
            {cartDetails.length === 0 ? (
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
                        ...
                        <form className="space-y-4">
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" className="w-full p-3 bg-brand-primary border border-brand-text/10 rounded-lg focus:border-brand-text focus:ring-1 focus:ring-brand-text outline-none" />
                                </div>
                                <div>
                            ...
                            <div>
                                ...
                                <input type="tel" className="w-full p-3 bg-brand-primary border border-brand-text/10 rounded-lg focus:border-brand-text focus:ring-1 focus:ring-brand-text outline-none" />
                            </div>
                        </form>
                    </div>
                    ...
                    <div className="bg-brand-primary p-8 rounded-2xl">
                        ...
                        <button className="w-full mt-4 h-12 bg-brand-secondary text-brand-bg font-medium uppercase tracking-wider hover:opacity-80 transition-opacity rounded-full">
                            Place Order (COD)
                        </button>
