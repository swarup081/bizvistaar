...
export default function CheckoutPage() {
    ...
    return (
        <div className="container mx-auto px-6 py-20 font-sans">
            <h1 className="text-6xl font-serif font-medium text-brand-text text-center mb-16">Checkout</h1>
            ...
            {cartDetails.length === 0 ? (
                <div className="text-center">
                    ...
                    <a 
                        href="shop"
                        className="mt-8 inline-block bg-brand-secondary text-brand-bg px-8 py-3 font-medium uppercase tracking-wider rounded-full"
                    >
                        Start Shopping
                    </a>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
                        ...
                        <form className="space-y-4" onSubmit={handlePlaceOrder}>
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        type="text"
                                        className={cn("w-full p-3 bg-brand-primary border rounded-lg focus:border-brand-text focus:ring-1 focus:ring-brand-text outline-none transition-all", fieldErrors.firstName ? "border-red-500" : "border-brand-text/10")}
                                    />
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        onChange={handleChange}
                                        type="text"
                                        className={cn("w-full p-3 bg-brand-primary border rounded-lg focus:border-brand-text focus:ring-1 focus:ring-brand-text outline-none transition-all", fieldErrors.lastName ? "border-red-500" : "border-brand-text/10")}
                                    />
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className={cn("w-full p-3 bg-brand-primary border rounded-lg focus:border-brand-text focus:ring-1 focus:ring-brand-text outline-none transition-all", fieldErrors.phone ? "border-red-500" : "border-brand-text/10")}
                                />
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={handleChange}
                                    type="text"
                                    className={cn("w-full p-3 bg-brand-primary border rounded-lg focus:border-brand-text focus:ring-1 focus:ring-brand-text outline-none transition-all", fieldErrors.address ? "border-red-500" : "border-brand-text/10")}
                                />
                             ...
                             <div>
                                ...
                                <input
                                    ...
                                    onChange={handleChange}
                                    type="text"
                                    className={cn("w-full p-3 bg-brand-primary border rounded-lg focus:border-brand-text focus:ring-1 focus:ring-brand-text outline-none transition-all", fieldErrors.city ? "border-red-500" : "border-brand-text/10")}
                                />
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        onChange={handleChange}
                                        type="text"
                                        className={cn("w-full p-3 bg-brand-primary border rounded-lg focus:border-brand-text focus:ring-1 focus:ring-brand-text outline-none transition-all", fieldErrors.zipCode ? "border-red-500" : "border-brand-text/10")}
                                    />
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={handleChange}
                                    type="text"
                                    className="w-full p-3 bg-brand-primary border border-brand-text/10 rounded-lg focus:border-brand-text focus:ring-1 focus:ring-brand-text outline-none transition-all"
                                />
                            </div>
                        </form>
                    </div>
                    ...
                    {/* Order Summary */}
                    <div className="bg-brand-primary p-8 rounded-2xl h-fit">
                            ...
                            {cartDetails.map(item => (
                                <div key={item.id} className="flex items-center gap-4">
                                    ...
                                    <div className="flex-grow">
                                        <h3 className="font-medium text-brand-text uppercase tracking-wider">{item.name}</h3>
