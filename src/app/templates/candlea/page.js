...
const ShippingIcon = () => ( // Using a candle icon as a placeholder
    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 opacity-80" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
        <path strokeLinecap="round" strokeLinejoin="round" d="M17.657 18.657A8 8 0 016.343 7.343m11.314 11.314a8 8 0 01-11.314 0m11.314 0L21 21m-2.657-2.657L12 12m5.657 5.657l-2.829-2.829m0 0a2 2 0 10-2.828-2.828 2 2 0 002.828 2.828z" />
    </svg>
);
