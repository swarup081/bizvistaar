  ...
  return (
    <div className="rounded-2xl bg-white p-6 shadow-sm flex flex-col justify-between h-[180px]">
      <div className="flex items-center gap-4">
        ...
        <span className="text-base font-bold text-gray-700 font-sans">{title}</span>
      </div>
      <div>
        <h3 className="text-4xl font-extrabold text-gray-900 font-sans tracking-tight">{value}</h3>
